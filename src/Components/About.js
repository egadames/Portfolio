    ...
    return (
      ...
      <div className="row">
         ...
         <div className="nine columns main-col">
            ...
            <ul className="social">
               <a href='https://www.linkedin.com/in/erik-adames-564b17bb/' className="button btn github-btn" target="_blank" rel="noopener noreferrer"><i className="fa fa-linkedin" ></i>Linkedin</a>
